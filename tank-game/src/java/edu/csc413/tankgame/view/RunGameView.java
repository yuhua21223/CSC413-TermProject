...
public class RunGameView extends JPanel {
    ...
    //Adding 3rd tank into game
    public static final String AI_TANK_2_IMAGE_FILE = "ai-tank.png";
    ...
    //We can have SHELL's initial start point at where the tank are



    //Then we can start working on limiting bullet and collision.
